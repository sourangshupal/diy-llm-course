...
1. [`lab/01_language_id.py`](./lab/01_language_id.py) — identify document languages.
2. [`lab/02_quality_filter.py`](./lab/02_quality_filter.py) — rule-based and model-based quality filtering.
3. [`lab/03_dedup.py`](./lab/03_dedup.py) — MinHash near-duplicate detection.

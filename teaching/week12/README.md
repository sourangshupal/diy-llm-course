...
1. [`lab/lm_eval_demo.py`](./lab/lm_eval_demo.py) — run a standard benchmark.
2. [`lab/custom_eval.py`](./lab/custom_eval.py) — build a custom evaluation.
3. [`lab/evalscope_demo.py`](./lab/evalscope_demo.py) — overview of evalscope (optional).

...
1. [`lab/model.py`](./lab/model.py) — full decoder-only Transformer.
2. [`lab/data.py`](./lab/data.py) — tiny dataset utilities.
3. [`lab/train.py`](./lab/train.py) — training loop.
4. [`lab/generate.py`](./lab/generate.py) — text generation.

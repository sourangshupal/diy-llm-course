...
- [`setup_check.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week01/lab/setup_check.py)
- [`wandb_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week01/lab/wandb_demo.py)

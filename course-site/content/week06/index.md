...
1. [`lab/01_matmul_triton.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week06/lab/01_matmul_triton.py) — fused matmul kernel.
2. [`lab/02_flash_attention.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week06/lab/02_flash_attention.py) — tiled attention kernel.

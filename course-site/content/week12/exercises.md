...
- [`custom_eval.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week12/lab/custom_eval.py)
- [`evalscope_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week12/lab/evalscope_demo.py)
- [`lm_eval_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week12/lab/lm_eval_demo.py)

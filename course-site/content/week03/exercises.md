...
- [`01_embeddings.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/01_embeddings.py)
- [`02_rope.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/02_rope.py)
- [`03_attention.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/03_attention.py)
- [`04_rmsnorm_swiglu.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/04_rmsnorm_swiglu.py)

...
1. [`lab/01_embeddings.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/01_embeddings.py) — token + positional embeddings.
2. [`lab/02_rope.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/02_rope.py) — Rotary Positional Embeddings.
3. [`lab/03_attention.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/03_attention.py) — causal self-attention.
4. [`lab/04_rmsnorm_swiglu.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week03/lab/04_rmsnorm_swiglu.py) — normalization and activation FFN.

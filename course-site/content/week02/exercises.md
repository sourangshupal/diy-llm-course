...
- [`bpe_from_scratch.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/bpe_from_scratch.py)
- [`inspect_tokenizer.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/inspect_tokenizer.py)
- [`train_hf_tokenizer.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/train_hf_tokenizer.py)

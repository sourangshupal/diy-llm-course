...
1. [`lab/bpe_from_scratch.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/bpe_from_scratch.py) — implement BPE by hand on a tiny corpus.
2. [`lab/train_hf_tokenizer.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/train_hf_tokenizer.py) — train a real BPE tokenizer with `tokenizers`.
3. [`lab/inspect_tokenizer.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week02/lab/inspect_tokenizer.py) — analyze the learned vocabulary and merges.

...
1. [`lab/scaling_law.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/scaling_law.py) — fit Chinchilla law to data.
2. [`lab/isoflops.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/isoflops.py) — simulate IsoFLOPs experiments.
3. [`lab/predict.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/predict.py) — predict loss for a target config.

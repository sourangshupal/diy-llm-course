...
- [`isoflops.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/isoflops.py)
- [`predict.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/predict.py)
- [`scaling_law.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week08/lab/scaling_law.py)

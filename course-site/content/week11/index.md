...
1. [`lab/reward_functions.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week11/lab/reward_functions.py) — reward functions and scoring.
2. [`lab/grpo_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week11/lab/grpo_demo.py) — simplified GRPO training loop.
3. [`lab/analyze_rewards.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week11/lab/analyze_rewards.py) — inspect reward components.

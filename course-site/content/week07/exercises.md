...
- [`communication_cost.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week07/lab/communication_cost.py)
- [`ddp_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week07/lab/ddp_demo.py)
- [`fsdp_demo.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week07/lab/fsdp_demo.py)

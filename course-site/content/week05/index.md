...
1. [`lab/profile_model.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/profile_model.py) — profile the Week 4 model with PyTorch profiler.
2. [`lab/roofline.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/roofline.py) — plot a roofline model for your GPU.
3. [`lab/memory_analysis.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/memory_analysis.py) — estimate activation memory.

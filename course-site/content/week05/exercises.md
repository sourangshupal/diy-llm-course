...
- [`memory_analysis.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/memory_analysis.py)
- [`profile_model.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/profile_model.py)
- [`roofline.py`](https://github.com/datawhalechina/diy-llm/blob/main/teaching/week05/lab/roofline.py)
